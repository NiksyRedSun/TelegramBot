...
class OrcMob(Mob):
    def __init__(self):
        ...
        self.char_killed_quotes = [f"Мгновение назад, вы отвлеклись на боль от ранения. А теперь "
    ...
    def give_in_dead_quotes_for_player(self):
        in_attack_quotes = [f"Сразу после разворота на ваш затылок опускается орочий меч. Последнее, что вы видите - орка, уходящего вдаль, без желания добивать своего врага",
                  ...
                  f"Развернувшись вы падаете, после удара орка ногой под вашу коленку. Перевернув вас на спину, он вставляет вам меч в грудь. Ваших сил недостаточно, чтобы попытаться вытащить лезвие и вы теряете сознание."]
